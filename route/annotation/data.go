...
// @description 返されるデータは左閉右開。タイムスタンプはUnixタイム(ミリ秒)。
...
// @router /annotation/hospitals/{hospital_uuid}/measurements/{measurement_id}/heartrates [get]
...
// @failure 404 {object} shared.ErrorResponse "患者が存在しない。"
// @failure 500 {object} shared.ErrorResponse "サーバエラーが発生。"
// @router /annotation/hospitals/{hospital_uuid}/measurements/{measurement_id}/tocos [get]
