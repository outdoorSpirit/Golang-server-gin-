...
func TestAnnotationData_ListHeartRate(t *testing.T) {
	...
	httpTests := test.HttpTests{
		{
			...
			Token:   auth.Token(0),
			Path:    "/annotation/hospitals/hospital-0001/measurements/2/heartrates",
			Check:   func(t *testing.T, rec *httptest.ResponseRecorder) {
				...
				for i, r := range res.Records {
					...
					assert.EqualValues(t, int64(beginTime.Add(time.Duration(1+i*4)*time.Second).UnixNano() / 1000000), r.ObservedAt)
				}
			},
		},
		{
			...
			Check:   func(t *testing.T, rec *httptest.ResponseRecorder) {
				...
				for i, r := range res.Records {
					...
					assert.EqualValues(t, int64(beginTime.Add(time.Duration(57+i*4)*time.Second).UnixNano() / 1000000), r.ObservedAt)
				}
			},
		},
		{
			...
			Method:  http.MethodGet,
			Token:   auth.Token(0),
			Path:    "/annotation/hospitals/hospital-0001/measurements/0/heartrates",
			Check:   func(t *testing.T, rec *httptest.ResponseRecorder) {
		...
		},
		{
			...
			Method:  http.MethodGet,
			Token:   auth.Token(0),
			Path:    "/annotation/hospitals/hospital-0000/measurements/2/heartrates",
			Check:   func(t *testing.T, rec *httptest.ResponseRecorder) {
				assert.Equal(t, http.StatusNotFound, rec.Code)
			},
		},
		{
			...
			Method:  http.MethodGet,
			Token:   auth.Token(0),
			Path:    "/annotation/hospitals/hospital-0002/measurements/2/heartrates",
			Check:   func(t *testing.T, rec *httptest.ResponseRecorder) {
				assert.Equal(t, http.StatusNotFound, rec.Code)
			},
		},
...
func TestAnnotationData_ListTOCO(t *testing.T) {
	auth := (&F.AnnotationFixture{}).Generate(3)
	...
	httpTests := test.HttpTests{
		{
			...
			Method:  http.MethodGet,
			Token:   auth.Token(0),
			Path:    "/annotation/hospitals/hospital-0001/measurements/2/tocos",
			Check:   func(t *testing.T, rec *httptest.ResponseRecorder) {
				assert.Equal(t, http.StatusOK, rec.Code)
		...
		},
		{
			...
			Method:  http.MethodGet,
			Token:   auth.Token(0),
			Path:    "/annotation/hospitals/hospital-0001/measurements/0/tocos",
			Check:   func(t *testing.T, rec *httptest.ResponseRecorder) {
				assert.Equal(t, http.StatusNotFound, rec.Code)
			},
		},
		...
		},
		{
			...
			Method:  http.MethodGet,
			Token:   auth.Token(0),
			Path:    "/annotation/hospitals/hospital-0002/measurements/2/tocos",
			Check:   func(t *testing.T, rec *httptest.ResponseRecorder) {
				assert.Equal(t, http.StatusNotFound, rec.Code)
			},
		},
